...
const skipRewrite = new Set([
  ...
  "isro-nrsc-remote-sensing-internship"
]);
const contentDir = path.join(projectRoot, "content", "internships");
const ogDir = path.join(projectRoot, "public", "og", "internships");

const iitData = [
  { name: "IIT Kanpur", city: "Kanpur", state: "Uttar Pradesh", website: "https://www.iitk.ac.in", domains: ["Aerospace and propulsion", "Cyber-physical systems", "Robotics and controls", "Data science and AI", "Materials and nanotech", "Energy and sustainability"], stipendNote: "Expected: select sponsored projects may fund interns; many roles remain certificate-only" },
  { name: "IIT Kharagpur", city: "Kharagpur", state: "West Bengal", website: "https://www.iitkgp.ac.in", domains: ["Manufacturing and industrial systems", "Computational mechanics", "Embedded systems and IoT", "Geoscience and remote sensing", "Agritech and water resources", "AI for industry"], stipendNote: "Expected: funded seats via grants; most offers are certificate + hostel" },
  { name: "IIT Roorkee", city: "Roorkee", state: "Uttarakhand", website: "https://www.iitr.ac.in", domains: ["Hydrology and water resources", "Earthquake engineering", "AI/ML and data systems", "Photonics and communications", "Transportation and infrastructure", "Sustainability and climate"], stipendNote: "Expected: limited stipends on sponsored projects; many roles certificate-only" },
  { name: "IIT Guwahati", city: "Guwahati", state: "Assam", website: "https://www.iitg.ac.in", domains: ["Computational mechanics", "Signal processing and communications", "Energy and biomass", "Data science and AI", "Robotics and control", "Materials and manufacturing"], stipendNote: "Expected: select sponsored seats offer stipends; hostel access common" },
  { name: "IIT Hyderabad", city: "Hyderabad", state: "Telangana", website: "https://iith.ac.in", domains: ["AI/ML and data science", "Semiconductors and VLSI", "Robotics and autonomous systems", "Materials and manufacturing", "Sustainable energy and grids", "Bioengineering"], stipendNote: "Expected: funded through industry and research grants; certificate-only otherwise" },
  { name: "IIT Indore", city: "Indore", state: "Madhya Pradesh", website: "https://www.iiti.ac.in", domains: ["AI/ML and computer vision", "Renewable energy and storage", "Robotics and controls", "Advanced materials", "Communications and signal processing", "Computational sciences"], stipendNote: "Expected: limited funded seats; most offers are certificate with hostel" },
  { name: "IIT Gandhinagar", city: "Gandhinagar", state: "Gujarat", website: "https://iitgn.ac.in", domains: ["Sustainable engineering", "Robotics and intelligent systems", "AI/ML and data", "Materials and mechanics", "Cognitive science and HCI", "Water and climate"], stipendNote: "Expected: grants may cover stipends; many roles are certificate-only" },
  { name: "IIT Bhubaneswar", city: "Bhubaneswar", state: "Odisha", website: "https://www.iitbbs.ac.in", domains: ["Climate and atmospheric science", "Power systems and smart grids", "AI/ML applications", "Materials and metallurgy", "Ocean and coastal engineering", "Robotics and controls"], stipendNote: "Expected: limited funded positions; certificate + hostel typical" },
  { name: "IIT Patna", city: "Patna", state: "Bihar", website: "https://www.iitp.ac.in", domains: ["AI/ML and data science", "Robotics and mechatronics", "VLSI and embedded systems", "Materials and manufacturing", "Communications and signal processing", "Energy systems"], stipendNote: "Expected: some funded via projects; many certificate-only" },
  { name: "IIT Ropar", city: "Rupnagar", state: "Punjab", website: "https://www.iitrpr.ac.in", domains: ["AI/ML and data", "Agritech and water", "Clean energy and hydrogen", "Robotics and cyber-physical systems", "Materials and manufacturing", "Biomedical engineering"], stipendNote: "Expected: grants fund select interns; certificate-only common" },
  { name: "IIT Mandi", city: "Mandi", state: "Himachal Pradesh", website: "https://www.iitmandi.ac.in", domains: ["AI/ML and computer vision", "Climate and sustainability", "Robotics and automation", "Computational sciences", "Materials and nanotech", "Healthcare tech"], stipendNote: "Expected: limited stipends via sponsored work; certificate + hostel otherwise" },
  { name: "IIT Jodhpur", city: "Jodhpur", state: "Rajasthan", website: "https://www.iitj.ac.in", domains: ["AI/ML and data", "Industry 4.0 and cyber-physical systems", "Energy and sustainability", "Healthcare and bioengineering", "Materials and manufacturing", "Communications and networks"], stipendNote: "Expected: some funded via industry projects; many certificate-only" },
  { name: "IIT (ISM) Dhanbad", city: "Dhanbad", state: "Jharkhand", website: "https://www.iitism.ac.in", domains: ["Mining and earth sciences", "Geospatial and remote sensing", "Energy and sustainability", "AI/ML applications", "Mechanical and manufacturing", "Environmental engineering"], stipendNote: "Expected: industry/mining sponsors may fund; certificate-only otherwise" },
  { name: "IIT BHU Varanasi", city: "Varanasi", state: "Uttar Pradesh", website: "https://www.iitbhu.ac.in", domains: ["Materials and metallurgy", "Power and energy", "AI/ML and data", "Electronics and VLSI", "Pharmaceutical and biotech", "Robotics and automation"], stipendNote: "Expected: limited funded seats via grants; certificate + hostel typical" },
  { name: "IIT Palakkad", city: "Palakkad", state: "Kerala", website: "https://iitpkd.ac.in", domains: ["AI/ML and data", "Systems and control", "Power and energy", "Materials and manufacturing", "Water and environment", "Robotics"], stipendNote: "Expected: limited funded slots; certificate + hostel typical" },
  { name: "IIT Tirupati", city: "Tirupati", state: "Andhra Pradesh", website: "https://iittp.ac.in", domains: ["AI/ML and data", "Smart infrastructure", "Power and energy", "Materials and manufacturing", "Robotics and mechatronics", "Water and environment"], stipendNote: "Expected: few funded; certificate-only common" },
  { name: "IIT Bhilai", city: "Bhilai", state: "Chhattisgarh", website: "https://www.iitbhilai.ac.in", domains: ["AI/ML and data", "Materials and manufacturing", "Power electronics and energy", "Robotics and automation", "Communications and signal processing", "Cyber-physical systems"], stipendNote: "Expected: grants may fund; certificate-only common" },
  { name: "IIT Goa", city: "Ponda", state: "Goa", website: "https://www.iitgoa.ac.in", domains: ["AI/ML and computing", "Power and energy", "Materials and manufacturing", "Thermal and fluid sciences", "Robotics and control", "Signal processing"], stipendNote: "Expected: limited funded seats; certificate + hostel typical" },
  { name: "IIT Jammu", city: "Jammu", state: "Jammu and Kashmir", website: "https://www.iitjammu.ac.in", domains: ["AI/ML and data", "Communications and signal processing", "Materials and manufacturing", "Power and energy", "Robotics and control", "Applied physics"], stipendNote: "Expected: few sponsored stipends; certificate-only otherwise" },
  { name: "IIT Dharwad", city: "Dharwad", state: "Karnataka", website: "https://www.iitdh.ac.in", domains: ["AI/ML and data", "Robotics and control", "Power and energy", "Materials and manufacturing", "Cyber-physical systems", "Signal processing"], stipendNote: "Expected: limited funded seats; certificate-only common" }
];

// Remove duplicates and include existing pilots separately? We will skip if file already exists.

function slugify(name) {
  return name.toLowerCase().replace(/\s+/g, "-").replace(/[()]/g, "").replace(/--+/g, "-") + "-summer-internship-2026";
}
...
function bodyContent(inst) {
  ...
  const short = inst.name.replace("Indian Institute of Technology ", "IIT ");
  const domainsList = inst.domains.map((d) => `- ${d}`).join("\n");
  const related = `- Scan the broader IIT ecosystem via the [IIT internships hub](/internships/iit-internships/).
...
## About the Institute
${inst.name} operates in ${inst.city}, ${inst.state}, giving interns access to regional industries and research ecosystems. The campus hosts active centers spanning ${inst.domains.slice(0, 3).join(", ")} and collaborates with government and industry sponsors. If you are comparing across the IIT system, anchor your choices with the IIT internships hub to see where this institute leads on depth, facilities, and sponsored work.
...
function frontmatter(inst) {
  const slug = slugify(inst.name);
  const short = inst.name.replace("Indian Institute of Technology ", "IIT ").replace(/[()]/g, "");
  return `---
...
async function writeInstitute(inst) {
  ...
  await fs.writeFile(svgPath, svgContent(inst.name, slug), "utf8");
}

async function main() {
  for (const inst of iitData) {
