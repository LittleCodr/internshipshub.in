            ...
            <div className="relative block">
              ...
              {profileOpen && user && (
                <div className="absolute right-0 z-40 mt-3 w-80 max-w-[calc(100vw-2rem)] rounded-2xl border border-emerald-100 bg-white p-4 text-sm shadow-xl shadow-emerald-100">
                  ...
                  <button
                    type="button"
                    className="mt-3 flex w-full items-center justify-center gap-2 rounded-xl border border-emerald-100 bg-white px-3 py-2 font-semibold text-emerald-900 transition hover:border-emerald-200 hover:bg-emerald-50"
                    onClick={() => {
                      signOut();
